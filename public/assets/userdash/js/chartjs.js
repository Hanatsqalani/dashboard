...
function getChartJs(type) {
    ...
    if (type === 'line') {
        config = {
            type: 'line',
            data: {
                labels: ["tanggal", "target", "realisasi"],
                datasets: [{
                    label: "",
                    data: [
                    <?php
                    $tanggal = mysqli_query($Charteaf, "select * from dashboard where charteafs = 'tanggal'");
                    echo mysqli_num_rows($tanggal);
                    ?>,
                    <?php
                    $target = mysqli_query($Charteaf, "select * from dashboard where charteafs = 'target'");
                    echo mysqli_num_rows($target);
                    ?>,
                    $realisasi = mysqli_query($Charteaf, "select *from dashboard where charteafs = 'realisasi'");
                    ],
                    ...
                    pointBorderWidth: 1
                        ...
                        label: "Target",
                        data: [28, 48, 40, 19, 86, 27, 90, 80, 81, 56, 55, 40, 59, 80, 81, 56, 55, 40, 59, 80, 81, 56, 55, 40, 59, 80, 81, 56, 55, 95],
