              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                       @foreach( $engineering as $foto)
                      <tr>
                        <td>
                         
                        </td>
                        <td>
                            <img src="{{ asset ('upload/Photoengineering') }}/{{$foto->fotoengineering}}" style="height: 120px; width: 170px;">
                        </td>
                        <td>
                           <form action="{{action('EngineeringController@destroy', $foto['id'])}}" method="post">
                              {{ csrf_field() }}
                  ...
                  {{ csrf_field() }}
                  <input type="file" name="fotoengineering" accept="image/jpeg" class="btn btn-danger">
