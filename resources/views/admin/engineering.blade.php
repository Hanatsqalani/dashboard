        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                 @foreach( $Photoengineering as $foto)
                <tr>
                  <td>
                    <p> {{$foto->filename}}</p>
                  </td>
                  <td>
                      <img src="{{ asset ('upload/Photoengineering') }}/{{$foto->filename}}" style="height: 120px; width: 170px;">
                  </td>
                  <td>
                     <form action="{{action('PhotoengineeringController@destroy', $foto['id'])}}" method="post">
                        {{ csrf_field() }}
            ...
            <form action="{{ route('engineering')}} " method="post" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table">
              ...
              <form action="{{ route('prestasiengineering')}} " method="post" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
