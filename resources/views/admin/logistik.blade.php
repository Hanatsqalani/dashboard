        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                 @foreach( $Photologistik as $foto)
                <tr>
                  <td>
                    <p> {{$foto->filename}}</p>
                  </td>
                  <td>
                      <img src="{{ asset ('upload/Photologistik') }}/{{$foto->filename}}" style="height: 120px; width: 170px;">
                  </td>
                  <td>
                     <form action="{{action('PhotologistikController@destroy', $foto['id'])}}" method="post">
                        {{ csrf_field() }}
            ...
            <form action="{{ route('logistik')}} " method="post" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table">
              ...
              <form action="{{ route('karyawanlogistik')}} " method="post" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
              ...
              <tbody>
                @foreach( $logistik as $datakaryawan)
                <tr>
                  <td>
                  ...
                  <td>
                    <form action="{{action('KaryawanlogistikController@destroy', $datakaryawan['id'])}}" method="post">
                        {{ csrf_field() }}
                        <input name="_method" type="hidden" value="DELETE">
                        <button class="btn btn-danger" type="submit">Delete</button>
                     </form>
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table">
              ...
              <form action="{{ route('prestasilogistik')}} " method="post" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
              ...
              <tbody>
                  @foreach( $Logprestasi as $dataprestasi)
                <tr>
                  <td>
                  ...
                  <td>
                    <form action="{{action('PrestasilogistikController@destroy', $dataprestasi['id'])}}" method="post">
                        {{ csrf_field() }}
                        <input name="_method" type="hidden" value="DELETE">
                        <button class="btn btn-danger" type="submit">Delete</button>
                     </form>
