      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#">SDM Engineering</a>
          </div>
...
<div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Data Karyawan Engineering</h4>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table">
              <strong>Create Data Karyawan</strong><br><br>
              <form action="{{ route('sdmengineering')}} " method="post" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
              ...
              <input type="hidden" name="bidang" id="bidang" value="Engineering">
              ...
              <br><br>
              Extension &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : <input type="text" name="extensionengineering"  id="extensionengineering" placeholder="Masukkan Extension Karyawan" class="col-md-3">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  @foreach( $Sdm as $datasdmengineering)
                  <td>
                    <p> {{$datasdmengineering->bidang}}</p>
                  </td>
                  <td>
                    <p> {{$datasdmengineering->jabatan}}</p>
                  </td>
                  <td>
                    <form action="{{action('KaryawanmaintenanceController@destroy', $datakaryawan['id'])}}" method="post">
                     ...
                     {{ csrf_field() }}
                        <button class="btn btn-success" type="submit" data-toggle="modal" data-target="#engineeringsdmmodal" data-id="{{$runningtext->id}}"
  ...
  <script>
  //modal
  $('#engineeringsdmmodal').on('show.bs.modal', function (event){
