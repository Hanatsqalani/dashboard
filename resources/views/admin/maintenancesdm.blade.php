      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#">SDM Maintenance</a>
          </div>
...
<div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Data Karyawan Maintenance</h4>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table">
              ...
              <input type="hidden" name="bidang" id="bidang" value="Maintenance">
              ...
              <br><br>
              Extension &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : <input type="text" name="extensionmaintenance"  id="extensionmaintenance" placeholder="Masukkan Extension Karyawan" class="col-md-3">
  ...
  <script>
  //modal
  $('#maintenancesdmmodal').on('show.bs.modal', function (event){
