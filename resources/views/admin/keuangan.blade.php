        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table">
              ...
              <form action="{{ route('karyawankeuangan')}} " method="post" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table">
              ...
              <form action="{{ route('prestasikeuangan')}} " method="post" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
              ...
              <tbody>
                  @foreach( $Keuanganprestasi as $dataprestasi)
                <tr>
                  <td>
