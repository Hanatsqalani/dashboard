      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#">Bakorsiroh</a>
          </div>
  ...
  <canvas id="bigDashboardChart"></canvas>
      ...
      <div class="row">
          <div class="col-md-12">
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                         <p> {{$fotobakorsiroh->filename}}</p>
                        </td>
                        <td>
                            <img src="{{ asset ('upload/Bakorsiroh') }}/{{$fotobakorsiroh->filename}}" style="height: 120px; width: 170px;">
                        </td>
                        <td>
                              <form action="{{action('BakorsirohController@destroy', $fotobakorsiroh['id'])}}" method="post">
                              {{ csrf_field() }}
                  ...
                  <form action="{{ route('bakorsiroh')}} " method="post" class="form-horizontal" enctype="multipart/form-data">
                  {{ csrf_field() }}
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Anggota Bakorsiroh</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
