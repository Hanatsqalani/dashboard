...
@endif
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#">SP PJB Service</a>
          </div>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                       @foreach($Sppjbs as $fotosppjbs)
                      <tr>
                        <td>
                         <p> {{$fotosppjbs->filename}}</p>
                        </td>
                        <td>
                            <img src="{{ asset ('upload/Sppjbs') }}/{{$fotosppjbs->filename}}" style="height: 120px; width: 170px;">
                        </td>
                        <td>
                              <form action="{{action('SppjbsController@destroy', $fotosppjbs['id'])}}" method="post">
                              {{ csrf_field() }}
                  ...
                  <form action="{{ route('sppjbs')}} " method="post" class="form-horizontal" enctype="multipart/form-data">
                  {{ csrf_field() }}
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      @foreach( $anggotasppjbs as $dataanggota)
                      <tr>
                        <td>
                        ...
                        <td>
                          <form action="{{action('AnggotasppjbsController@destroy', $dataanggota['id'])}}" method="post">
                        {{ csrf_field() }}
                              <input name="_method" type="hidden" value="DELETE">
                              <button class="btn btn-danger" type="submit">Delete</button>
                           </form>
                           {{ csrf_field() }}
                              <button class="btn btn-success" type="submit" data-toggle="modal" data-target="#sppjbsmodal" data-id="{{$dataanggota->id}}"
                              ...
                              @endforeach
                              <div class="modal fade" id="sppjbsmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                        aria-hidden="true">
  ...
  <script>
    ...
    <script>
      //modal
      $('#sppjbsmodal').on('show.bs.modal', function (event){
